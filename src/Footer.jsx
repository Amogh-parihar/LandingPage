...
import FeedbackPopup from "./NewFeedback";
import FeeddbackFloating from "./NewFeeddback";
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li>
                <a className="hover:text-orange-500" href="/learn">
                  Courses
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <a className="hover:text-orange-500" href="/DSA">
                  Data Structure
                </a>
              </li>
              <li>
                <a className="hover:text-orange-500" href="/SQL">
                  SQL
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <a className="hover:text-orange-500" href="/contests">
                  Daily Contest
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li>
                Phone:{" "}
                <a href="tel:+919876543210" className="hover:text-orange-500">
                  +91 98765 43210
                </a>
              </li>
